var websocket = null;
var websocket_url = "ws://" + window.document.location.host + '/room';
var health_url = "http://" + window.document.location.host + '/rest/health';
...
document.getElementById('socketUrl').innerHTML = websocket_url;
document.getElementById('healthUrl').innerHTML = health_url;
...
function join() {
  ...
  sendSocket('roomJoin,' + roomId.value + ',' + JSON.stringify(json));
}
